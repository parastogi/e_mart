			...
			<div class="col s10" id="current-content">
				<div class=" col s12 active" id="profile">
					...
					<div class="col m6 s12 valign-wrapper" id="profile-image">
						<?php 
							if(file_exists("images/userprofileimages/".$_SESSION['username'].".jpg")==true){
				...
				<div class="col s12" id="cart">
					...
					<?php
						...
						$db1= mysql_select_db('e_mart') or die("Unable to select to Database");
					...
					?>
								<div class="row item-card valign-wrapper-custom item_row">
									<div class="col m1-5 hide-on-small-only item-image">
										<?php echo '<img src="images/itemimages/'.$row['i_id'].'/1.jpg" class="responsive-img">'; ?>
									</div>
									<div class="col  s12 m3-5 item-info">
										<div class="row">
											<p class="item-name"><?php echo $row['i_name']; ?></p>
											<p class="hide-on-small-only"><?php echo $row['description']; ?></p>
										</div>
									</div>
									...
									<div class="col m2 s12 item-price">
										<p class="green-text">Rs. <?php echo $row['price']; ?></p>
									</div>
									<div class="col m1 s12 delete">
										<i class="material-icons tooltipped" data-position="left" data-tooltip="Remove item" id="delete_item_cart" data-id=<?php echo $row['i_id']; ?> >delete</i>
									</div>
								</div>
					<?php				
							}
					...
					<?php
						...
						while($row1 = mysql_fetch_assoc($result1)) {
							...
							/*	if($row['delivery_date']==NULL)
									$row['delivery_date'] = "Not Delivered";
							*/	echo"<tr data-id = ".$row['o_id'].">";
								if($flag!=1)
									echo"<td rowspan=". $row1['count'] .">". $row['o_id'] ."</td>";
	...
	<footer class="row lime darken-3">
		<div class="col s8 offset-s2">
			...
			<div class="col m4 section">
				...
				<ul>
					<li>IIIT Jabaplpur,</li>
					<li>Dunmna Airport Road,</li>
